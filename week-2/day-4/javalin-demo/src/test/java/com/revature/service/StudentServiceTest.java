...
public class StudentServiceTest {
    ...
    public void testGetAllStudents() throws SQLException {
        ...
        fakeStudents.add(new Student(2, "Test", "Test", 15));
    ...
    public void testGetStudentById_positiveTest() throws SQLException, StudentNotFoundException {
        ...
        Student fakeStudent = new Student(10, "Test", "Testy", 20);
        // Mocking the return value for id 10
        when(mockDao.getStudentById(eq(10))).thenReturn(fakeStudent);
    ...
    public void test_addStudent_positiveTest() throws SQLException {
        ...
        when(mockDao.addStudent(eq(new Student(0, "Bach", "Tran", 24))))
                .thenReturn(new Student(10, "Bach", "Tran", 24));

        StudentService studentService = new StudentService(mockDao);

        // Act
        Student actual = studentService.addStudent(
                new Student(0, "Bach", "Tran", 24)
        );

        // Assert
        Student expected = new Student(10, "Bach", "Tran", 24);
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void test_addStudent_nonAlphabeticalCharactersInFirstName() throws SQLException {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            studentService.addStudent(new Student(0, "Bach123", "Tran", 24));
        });
    }
    ...
    public void test_addStudent_nonAlphabeticalCharactersInLastName() {
        ...
        // Act + Assert
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            studentService.addStudent(new Student(0, "Bach", "43Tran", 24));
        });
    }
    ...
    public void test_addStudent_negativeAge() {
        ...
        // WE're only using the mock here to prevent access to the
        // actual dao layer, and hence the actual database
        StudentService studentService = new StudentService(mockDao);

        // Act + Assert
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
           studentService.addStudent(new Student(0, "Test", "Test", -10));
        });
    }
}
